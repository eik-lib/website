...
Creating import map aliases allows you to include the import map alias in your application's `eik.json` (or `package.json` `eik` field) file without the need to update it every time you publish a new version of the import map.
